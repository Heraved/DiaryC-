       ...
       
    {
        public static void Menu()
        {
            ...
            while (true)
            {
                ...
                {
                    case ConsoleKey.D1:
                        Console.Clear(); StudentsContainer.CreateStudent(); break;
                    case ConsoleKey.D2:
                        Console.Clear(); StudentsContainer.AddGrades(); break;
                    case ConsoleKey.D3:
                        Console.Clear(); StudentsContainer.CreateStudent(); break;
                    case ConsoleKey.D4:
                        Console.Clear(); break;
                    case ConsoleKey.D5:
                        Console.Clear(); StudentsContainer.PrintAllStudents(); break;
                    case ConsoleKey.D6:
